...
function SimilarRecommendation() {
  return (
    <div className='mt-10 p-5'>
      <h3 className="mb-10 text-3xl text-center leading-tight font-bold">Similar Gift Recommendations</h3>
          ...
          cakes.map((i) => {
            return (<>
              <div
                ...
                <div className='absolute top-0 right-0 border rounded-bl-lg  p-2 bg-white'>nd</div>
                <div className="p-5">
                  <p>{i.cakeName}</p>
